...
Switch_params = {
    ...
    'EpsOn_actOn' : 3000, #On state Epsilon during On switch phases for actinic laser (405nm)
    'EpsOn_actOff' : 30000, #On state Epsilon during Off switch phases for actinic laser (561nm)
...
EpsDark_actOn = 2051.5537608830286
EpsDark_actOff = 22.953681666032455
EpsDark_RO = 3071.9530230874025

# Define initial concentration of each state, no concentration should be equal to zero
FP_init = 1090.520519254158 #Initial level of fluorescence
On_init = 0.12077816685869913 #Fraction of On state proteins
Off_init = 0.2499867398970068 #Fraction of Off state proteins
Dark_init = 0.5709833742105225 #Fracion of Dark state proteins
    
# Define the switching quantum yields
qOnOff = 0.028614083092770914
qOffOn = 0.08023424149176471
qDarkOn = 2.6241865495998815e-05

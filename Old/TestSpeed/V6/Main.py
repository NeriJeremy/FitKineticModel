...
Switch_params = {
    ...
    'EpsOn_actOn' : 1450, #On state Epsilon during On switch phases for actinic laser (405nm)
...
EpsDark_actOn = 1394.981889991544
EpsDark_actOff = 0
EpsDark_RO = 0

# Define initial concentration of each state, no concentration should be equal to zero
FP_init = 2932.7576715551236 # Initial level of fluorescence
On_init = 0.08609916651438147 # Fraction of On state proteins
Off_init = 0.6431028683178384 # Fraction of Off state proteins
Dark_init = 0.929903326021433 # Fracion of Dark state proteins
    
# Define the switching quantum yields
qOnOff = 5.399167884370319e-04
qOffOn = 9.433273959647497e-06
qDarkOn = 0.0004124708228238905

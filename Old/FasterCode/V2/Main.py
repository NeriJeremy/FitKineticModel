...
Fit_params = {
    ...
    'On_init' : 9.91669815e-01, #Fraction of On state proteins
    'Off_init' : 6.02835222e-01, #Fraction of Off state proteins
    'Dark_init' : 2.51013320e+00, #Fracion of Dark state proteins
    ...
    'Th_OnOff' : 4.21345281e+00,
    'Th_DarkOff' : 1.15460796e-03,
    
}

# Define the fixed parameters
start = np.array([[Fit_params['EpsDark_actOn'], True],

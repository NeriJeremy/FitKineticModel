...
class FitFun:
    ...
    def fit_DARKONOFF(self, xtofit, ytofit):
        try:
            ...
            if self.check_fit:
                print("yFitStart = ", yfit_start)
                print("xFitStart = ", xfit_start)
    ...
    Fitting of the model
                ...
                lower_b = np.zeros(len(self.Fit_params))
                upper_b = np.full(len(self.Fit_params), np.inf) # np.inf to not put any upper bound
